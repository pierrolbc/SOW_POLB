...
*
* date modifier : 14/10/2020
* @since 2020 14 octobre
...
$WEB_canonical = 'https://www.schoolofweb.tech/Pierre_Olivier_L_B/'; // MODIFIABLE Nom de l'url du site (complet avec / a la fin)
$WEB_canonical_Short = 'www.schoolofweb.tech/Pierre_Olivier_L_B/'; // MODIFIABLE Nom de l'url du site (complet avec / a la fin sans http)
...
$TITLE_index = "https://www.schoolofweb.tech/Pierre_Olivier_L_B/#home"; // MODIFIABLE Nom de la page d'index
$TITLE_description = "Pierre-Olivier LB Web CV"; // MODIFIABLE description du site. Pour les accents utiliser le codage HTML. 200 c Max !
$TITLE_author = "Pierre-Olivier Le Bellec"; // MODIFIABLE Indique le nom ou la société créatrice du site et du CODE !
$TITLE_news_keywords = "Pierre-Olivier Le Bellec, School, Of Web, School Of Web, html5, css3, javascript, php, developper, developpeur, apache, SSL"; // MODIFIABLE Pour google uniquement. Max 10 expression séparer par VIRGULE
...
// Picto Menu et Nav Footer CV Fontawesome 5.9.0
$picto_menu = '<font color="AQUAMARINE"><i class="icon solid fa-home"></i>';
$picto_skill = '<font color="AQUAMARINE"><i class="icon solid fa-cubes"></i>';
$picto_work = '<font color="AQUAMARINE"><i class="icon solid fa-code"></i>';
$picto_contact = '<font color="AQUAMARINE"><i class="icon solid fa-envelope"></i>';
...
$FILEFAVICON = 'Favicon.ico'; // AUTOMATIQUE plus le nom de l'image du FAVICON
$FILE_FAVICON = 'Favicon.ico'; // AUTOMATIQUE plus le nom de l'image du FAVICON
...
$FILE_CSS_FAW = ''.$fa5_master_css.'fontawesome-all.min.css'; // AUTOMATIQUE Fichier CSS pour FONT Awesome icons
